...
class Command(enum.IntEnum):
    ...
    T55XX_READ_BLOCK = 3010
    T55XX_WRITE_BLOCK = 3011
    HID_PROX_SCAN = 3020
    HID_PROX_WRITE_TO_T55XX = 3021
    INDALA_SCAN = 3030
    INDALA_WRITE_TO_T55XX = 3031
    FDX_B_SCAN = 3040
    PARADOX_SCAN = 3050
    KERI_SCAN = 3060
    AWD_SCAN = 3070
    ...
    HID_PROX_GET_EMU_DATA = 5020
    HID_PROX_SET_EMU_DATA = 5021
    INDALA_GET_EMU_ID = 5030
    INDALA_SET_EMU_ID = 5031
